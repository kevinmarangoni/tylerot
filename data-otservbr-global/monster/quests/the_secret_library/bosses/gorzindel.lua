...
monster.attacks = {
	...
	{ name = "melee", interval = 1500, chance = 15, minDamage = -600, maxDamage = -2800 },
	{ name = "melee", interval = 1500, chance = 15, minDamage = -800, maxDamage = -1300 },
	{ name = "melee", interval = 1500, chance = 15, minDamage = -800, maxDamage = -1000 },
	{ name = "melee", interval = 1500, chance = 15, minDamage = -200, maxDamage = -800 },
